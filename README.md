 ...
 ## 7. 음성문구 정의
  ...
  1. 계기수령  ([듣기 1.1](./1.1.mp3), [듣기 1.2](./1.2.mp3), [듣기 1.3](./1.3.mp3), [듣기 1.4](./1.4.mp3))
    ...
    1.2 휴대폰  > 패스워드 
       ...
       문자메시지로 받으신 비밀번호를 입력해 주십시오.
       
    1.3 패스워드 > 보관함맵
    
       계기가 보관된 함이 선택되어 있습니다. 확인을 누르시면 보관함 문이 열립니다. 
   ...
   2. 계기 반납 ([듣기 2.1](./2.1.mp3), [듣기 2.2](./2.2.mp3), [듣기 2.3](./2.3.mp3))
    ...
    1.3 보관함맵  > 완료 
       보관함 문이 열렸습니다. 계기를 반납하시기 바랍니다. 계기를 반납하신 후 보관함 문을 꼭 닫아 주십시오. 감사합니다.[듣기!]
